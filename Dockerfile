...
RUN apk add --no-cache --virtual .build-deps \
      ...
      make \
      g++ && \
    npm install -g obsidian-headless@0.0.11 && \
...
#
# Disabled by default because many git servers do not have LFS enabled.
# Set OBSIDIAN_GIT_LFS_ENABLED=true to activate.
#
